...
Public Function ExportExcel(strkodedept As String)
    ...
    sql = " SELECT * FROM tag_stock_opname_fbi " & strkodedept & " "
...
Private Sub cexport_Click()
    Select Case cdepartment.ListIndex
        ...
        Case 1
            ExportExcel "WHERE left(tag_no,3)='GTS' and status='" & cstatus.Text & "'"
        Case 2
            ExportExcel "WHERE left(tag_no,2)='GF' and status='" & cstatus.Text & "'"
        Case 3
            ExportExcel "WHERE left(tag_no,2)='GG' and status='" & cstatus.Text & "'"
        Case 4
            ExportExcel "WHERE left(tag_no,2)='GP' and status='" & cstatus.Text & "'"
        Case 5
            ExportExcel "WHERE left(tag_no,2)='MS' and status='" & cstatus.Text & "'"
        Case 6
            ExportExcel "WHERE left(tag_no,2)='EM' and status='" & cstatus.Text & "'"
        Case 7
            ExportExcel "WHERE left(tag_no,2)='EF' and status='" & cstatus.Text & "'"
        Case 8
            ExportExcel "WHERE left(tag_no,3)='GJF' and status='" & cstatus.Text & "'"
        Case 9
            ExportExcel "WHERE left(tag_no,2)='SW' and status='" & cstatus.Text & "'"
        Case 10
            ExportExcel "WHERE left(tag_no,2)='FP' and status='" & cstatus.Text & "'"
        Case 11
            ExportExcel "WHERE left(tag_no,3)='GAJ' and status='" & cstatus.Text & "'"
        Case 12
            ExportExcel "WHERE left(tag_no,3)='GAT' and status='" & cstatus.Text & "'"
        Case 13
            ExportExcel "WHERE left(tag_no,3)='ITJ' and status='" & cstatus.Text & "'"
        Case 14
            ExportExcel "WHERE left(tag_no,3)='ITT' and status='" & cstatus.Text & "'"
        Case 15
            ExportExcel "WHERE left(tag_no,3)='SBY' and status='" & cstatus.Text & "'"
        Case 16
            ExportExcel "WHERE left(tag_no,3)='KSY' and status='" & cstatus.Text & "'"
        Case 17
